...
<html>
	...
	<head>
        ...
        <link href="<c:url value='/css/layui.css'/>" rel="stylesheet" media="all" type="text/css"/>
        <link href="<c:url value='/css/global.css'/>" rel="stylesheet" media="all" type="text/css"/>
				...
				<div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
					...
					<div class="layui-tab-content" style="min-height: 150px; padding: 5px 0 0 0;">
						<div class="layui-tab-item layui-show">
							<iframe src="${basePath }/views/admin/main.html"></iframe>
						</div>
					</div>
				</div>
			</div>
